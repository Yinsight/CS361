...
// This class is provided, does not need to do anything.
...
public class Program {
	...
	public String display() {  //print the tree
		int level = 0;
...
class Declarations extends Vector {  //why vector? because it is a collection.
...
class Type {
	...
	public Type(String t) { //this method is a constructor
		id = t;
	}
...
class Block extends Statement {
	// Block = Statement*
	//		   (a Vector of members)
    // why can we do vector for rule no.2 but not here?
    // because we cannot do a second extend
    // so we put an instance varibale blockmembers below
...
class Variable extends Expression { //captures xxx
	// Variable = String id
    ...
    //whether id is uppercase or not, it is the same
...
class Value extends Expression { //captures int and boolean
...
class Operator { //harder to write: closer to bottom of tree
    //several rules captured in one class
